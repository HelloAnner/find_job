      ...
      <div className="relative">
        <button
          ...
          className={`
            ...
            bg-white dark:bg-[#0f1922] ring-1 ring-slate-200/70 dark:ring-white/10
        ...
        {open && (
          <div
            ...
            className="absolute z-20 mt-2 w-full rounded-xl bg-white dark:bg-[#0f1922] shadow-2xl shadow-slate-900/30 ring-1 ring-slate-200/80 dark:ring-white/10 max-h-64 overflow-auto animate-fade-in"
          >
            {options.map((opt, idx) => {
